...
function applyMediaSession(sound) {
  if ("mediaSession" in navigator) {
    ...
    navigator.mediaSession.setActionHandler('previoustrack', () => { audioFix.play().catch(() => {}); widget.prev(); });
    navigator.mediaSession.setActionHandler('nexttrack', () => { audioFix.play().catch(() => {}); widget.next(); });
